...
{{site.data.keyword.cp4mcm_full_notm}} supports upgrading within the the main version. It does not support upgrading between main versions. For example, you cannot upgrade from Version 1.x to Version 2.x. The {{site.data.keyword.cp4mcm_full_notm}} upgrade paths within the main version are:
